...
import com.blackcat.core.handler.ClientHandler;
 ...
 */
@Slf4j
public class ConsumerClient implements Client, InitializingBean {
    private EventLoopGroup eventLoopGroup;
    private Channel channel;
    private ClientHandler clientHandler;
    @Value("${rpc.center.host}")
    ...
    public void connect() {
        ...
        connect(bootstrap, centerHost, centerPort, MAX_RETRY);
    }
